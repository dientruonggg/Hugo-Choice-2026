  ...
  return (
    <div className="relative flex-1 flex items-center justify-center w-full min-h-[80vh] px-4 py-8">
      ...
      <div className="relative w-full max-w-2xl p-6 sm:p-10 md:p-12 rounded-3xl glass-panel-dark border border-white/40 shadow-2xl flex flex-col items-center text-center text-white z-20 my-auto">
        ...
        {/* Title */}
        <h2 className="font-cinzel text-2xl sm:text-4xl md:text-5xl font-extrabold tracking-wider text-white text-shadow-elegant mb-6 sm:mb-8 border-b border-white/20 pb-4 w-full">
        ...
        <div className="mb-6 space-y-2">
          ...
          <p className="font-serif-display text-sm sm:text-lg text-white/90 leading-relaxed max-w-xl mx-auto">
            Best Member, Best Event, The Rookie, The Perfect Duo, Best Short Story, Best Graphic Story, Best Dramatic Presentation, etc.
          </p>
        </div>

        {/* Content Paragraph 2: Timeline */}
        <div className="mb-8 space-y-2">
          <h3 className="font-serif-display text-lg sm:text-2xl font-bold text-amber-200">
            Event Timeline
          </h3>
          <ul className="font-serif-display text-sm sm:text-lg text-white/90 leading-relaxed space-y-1">
            <li><strong className="text-amber-300">Nominations Open:</strong> Jan 1</li>
            <li><strong className="text-amber-300">Voting Begins:</strong> Apr 1</li>
            <li><strong className="text-amber-300">Awards Ceremony:</strong> Aug 16</li>
          </ul>
        </div>
