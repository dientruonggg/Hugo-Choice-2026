...
export const BackgroundLandscape: React.FC<BackgroundLandscapeProps> = ({
  ...
  return (
    <div className="relative h-screen max-h-screen w-full overflow-hidden bg-[#101b13] flex flex-col selection:bg-amber-300 selection:text-black">
      ...
      {/* Main Content Container (Scrollable Vertically) */}
      <div className="relative z-10 flex-1 flex flex-col w-full h-full overflow-y-auto min-h-0">
        <div className="flex-1 flex flex-col justify-between w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          {children}
        </div>
      </div>
    </div>
