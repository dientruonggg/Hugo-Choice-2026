/**
 * HTML Email Template Generator for Hugo Award 2026 Ballot Receipt
 * Produces an exact visual replica of the SubmissionScreen Modal UI.
 */
export function generateBallotEmailHtml(data) {
  ...
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="width: 100%; background-color: #0d1710;">
    <tr>
      <td align="center">
        ...
        <!-- Main Receipt Container (Matches SubmissionScreen Modal UI) -->
